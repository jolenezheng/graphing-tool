...
var t = 1;
;
function getWaypoints(line) {
    var numPoints = line.points.length;
    var vertices = [];
    var waypoints = [];
    for (var i = 0; i < numPoints; i++) {
...
function generateSeriesColour(series) {
...
function generateSeriesPoints(numPoints) {
    var newSet = [];
    for (var i = 0; i < numPoints; i++) {
...
document.getElementById("add-line-btn").addEventListener("click", function () {
    var numDataSet = testDataSet.length;
    var numPoints = testDataSet.length > 0 ? testDataSet[0].points.length : 10;
    var newPoints = [];
    var newCss = {
