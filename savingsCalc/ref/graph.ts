...
export interface INumberStyles {
...
export function isLine(obj: ILine | IBar): obj is ILine {
...
export function addCoordToPoint(p: Point, x: number, y: number, width: number, height: number): void {
    p.coords.x1 = x;
    p.coords.x2 = x + width;
    p.coords.y1 = y;
